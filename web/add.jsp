...
<form action="<%=request.getContextPath()%>/add" method="post">
    ...
    <input type="submit" name="ok" value="<fmt:message key="AddPanel.ok" bundle="${lang}"/>">
    <input type="submit" name="cancel" value="<fmt:message key="AddPanel.cancel" bundle="${lang}"/>">
</form>
